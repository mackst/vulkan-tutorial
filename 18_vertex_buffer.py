...
class HelloTriangleApplication(QtGui.QWindow):
    ...
    def __createVertexBuffer(self):
        bufferInfo = VkBufferCreateInfo(
            size=len(self.__vertices) * self.__vertices.itemsize,
        ...
        allocInfo = VkMemoryAllocateInfo(
            ...
            memoryTypeIndex=self.__findMemoryType(memRequirements.memoryTypeBits,
        ...
        ffi.memmove(data, vertePtr, bufferInfo.size)
