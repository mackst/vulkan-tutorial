...
# https://github.com/mackst/tinyobjloader
# with pybind11
import tol
...
class HelloTriangleApplication(QtGui.QWindow):
    ...
    def __createImageViews(self):
        ...
        for i, image in enumerate(self.__swapChainImages):
            self.__swapChainImageViews.append(self.__createImageView(image, self.__swapChainImageFormat, VK_IMAGE_ASPECT_COLOR_BIT))
    ...
    def __loadModel(self):
        startTime = time.time()
        vertexData, indexData = tol.loadModel(self.modelPath)
