...
namespace texture_image
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public void CreateTextureImage()
        {
            ...
            (textureImage, textureImageMemory) = CreateImage((uint)texWidth, (uint)texHeight, Format.R8G8B8A8Unorm, ImageTiling.Optimal, ImageUsageFlags.TransferDst | ImageUsageFlags.Sampled, MemoryPropertyFlags.DeviceLocal);

            TransitionImageLayout(textureImage, Format.R8G8B8A8Unorm, ImageLayout.Undefined, ImageLayout.TransferDstOptimal);
            CopyBufferToImage(stagingBuffer, textureImage, (uint)texWidth, (uint)texHeight);
            TransitionImageLayout(textureImage, Format.R8G8B8A8Unorm, ImageLayout.TransferDstOptimal, ImageLayout.ShaderReadOnlyOptimal);
